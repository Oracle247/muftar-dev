...
const DriverDetails = ({ isOpen, closeModal }: DriverDetailsProps) => {
  return (
    <Modal isOpen={isOpen} className="flex items-center justify-center">
      ...
      >
        <ModalCardHeader title="Driver Details" closeHandler={closeModal} />
        <div className="scroller flex max-h-[450px] flex-col gap-6 overflow-auto px-10 py-4">
          <div className="grid grid-cols-2 gap-6">
            <div>
              <div className="flex flex-col gap-6">
                <DetailCard heading="Driver ID" message1="DRV-001" />
                <DetailCard heading="Name" message1="John Doe" />
                <DetailCard
                  heading="Current Location"
                  message1="New York, NY"
                />
            ...
            <div>
              <div className="flex flex-col gap-6 border-b border-muftar-gray-300 pb-6">
                <DetailCard
                  ...
                  message1="XXXXXXXXX"
                />
                <DetailCard heading="Experience" message1="5 years" />
                <DetailCard
                  heading="Contacts"
                  message1="john.doe@example.com"
                />
              </div>
